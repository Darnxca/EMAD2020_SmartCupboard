...
class RicetteHealthy extends StatefulWidget {
  @override
  _RicetteHealthyState createState() => _RicetteHealthyState();
}

class _RicetteHealthyState extends State<RicetteHealthy> {
  ...
  Widget build(BuildContext context) {
    return  Expanded(
        child: FutureBuilder(
            future: getDataService.gellAllRicetteHealthy(),
